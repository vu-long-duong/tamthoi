...
<body class="g-sidenav-show   bg-gray-100">
    <form action="{{route('admin.create-film-genre')}}" method="GET">
                                    ...
                                    <table class="table align-items-center mb-0" id="myTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Name Genre</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">{{$value->namegenre}}</p>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{route('admin.edit-film-genre',['id'=>$value->id])}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                        Edit
                                                    </a>
                                                </td>
                                            </tr>
