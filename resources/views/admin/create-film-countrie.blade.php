...
<body class="g-sidenav-show g-sidenav-pinned">
    ...
    <div class="main-content" id="panel">
        ...
        <div class="container center ">
            <form action="{{route('admin.store-film-countrie')}}" method="POST">
                @csrf
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">Create countrie</h3>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="heading-small text-muted mb-4">Create countrie</h6>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-username">Name countrie</label>
                                            <input type="text" id="input-username" class="form-control" placeholder="Name categories..." name="name" value="{{old('name')}}">
                                        </div>

                                        <div class="form-group">
                                            <label class="form-control-text" for="input-username">Describe</label>
                                            <input type="text" id="input-username" class="form-control" placeholder="Describe ..." name="describe" value="{{old('describe')}}">
                                        </div>
