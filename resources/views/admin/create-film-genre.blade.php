...
<body class="g-sidenav-show g-sidenav-pinned">
    ...
    <div class="main-content" id="panel">
        ...
        <div class="container center ">
            <form action="{{route('admin.store-film-genre')}}" method="POST">
                @csrf
                ...
                <div class="col-xl-7 order-xl-1">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="heading-small text-muted mb-4">Create Genre</h6>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-username">Name Genre</label>
                                            <input type="text" id="input-username" class="form-control" placeholder="Name Genre..." name="name" value="{{old('name')}}">
                                        </div>
